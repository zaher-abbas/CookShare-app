                ...
                if ($isConnected && $_SESSION['userRole'] === 'user') {
                    echo "<ul class='navbar-nav me-auto mb-2 mb-lg-0 mb-md-0'>
                        <li class='nav-item me-lg-3 mb-2 mb-md-2 mb-lg-0'>
                            <a class='btn btn-outline-success border-bottom border-3 text-light btn-md rounded-bottom-5 p-2 w-100 fw-bold' href='index.php?action=home'>&#127968; Home</a>
                        </li>
                ...
                <span class="d-flex align-items-center justify-content-center">
                    ...
                    <?php else: ?>
                      ...
                      <a href='index.php?action=profile'
                         ...
                         <li class='nav-item ms-xxl-4 ms-xl-3 ms-lg-3 mt-3 mt-md-3 mt-lg-0 logoutBtn'>
